...
public final class HuffmanEncoder {
	 ...
	 * header before calling write(). The tree can be changed after each symbol encoded, as long
	 ...
	 * @throws IllegalArgumentException if the symbol header is negative or has no binary code
	 */
