 ...
 *   <li>No symbol header is found in more than one leaf.</li>
 *   <li>Not every possible symbol header needs to be in the tree.</li>
 * </ul>
...
public final class CodeTree {
	 ...
	 */
	public final Node.Internal root;
	 ...
	 * Each symbol in the tree must have header strictly less than the symbol limit.
	 ...
	 * a header greater or equal to the symbol limit, or a symbol header appears more than once in the tree
	 */
	public CodeTree(Node.Internal root, int symbolLimit) {
